...
class TeacherFragment : BaseSettingFragment<Teacher>(3) {
    ...
    private fun initRecyclerView(data: List<Teacher>) {
    ...
    override fun addPosition(position: Int, data: Teacher) {
        with(viewModel) {
    ...
    override fun removePosition(position: Int, data: Teacher) {
